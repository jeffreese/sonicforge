...
export const btn = {
  primary: 'bg-primary text-on-primary hover:bg-primary-hover px-4 py-2 rounded-lg font-medium transition-colors',
  ghost: 'text-muted hover:text-on-surface hover:bg-surface-hover px-3 py-1.5 rounded transition-colors',
  icon: 'text-muted hover:text-on-surface hover:bg-surface-hover p-2 rounded transition-colors',
  danger: 'bg-error text-on-primary hover:bg-error/80 px-4 py-2 rounded-lg font-medium transition-colors',
};
...
export const input = {
  ...
  textarea: 'bg-surface-elevated text-on-surface border border-border rounded-lg px-3 py-2 focus:border-primary focus:outline-none resize-y',
};
...
export const panel = {
  ...
  header: 'border-b border-border px-4 py-2 text-muted text-sm font-medium uppercase tracking-wider',
  body: 'p-4',
};
